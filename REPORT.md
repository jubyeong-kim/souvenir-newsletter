...
- **분야**: 해외여행 기념품 — "이번 여행에 뭘 사올까"에 답하는 발견형(B2C) 뉴스레터.
  그 나라에서 파는 물건(아웃바운드)만 다루고, 역직구·인바운드는 다루지 않는다.
...
![디스코드 발행 화면](docs/discord.jpg)

> 2026-09-15 15:25 실발행. 헤드 임베드 1장 + 품목 임베드 2장.
> 소스가 날짜를 주지 않은 항목은 footer 에 `날짜 미확인` 으로 표시된다.
